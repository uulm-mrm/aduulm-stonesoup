...
from aduulm_scripts.utils.add_disturbance import disturbance_measurement_model
...
for k, state in enumerate(truth):
    ...
    measurement_model = disturbance_measurement_model(measurement_model, gt_measurement_configs, k)
...
from aduulm_scripts.utils.plotting import plot_selfassessment
plot_selfassessment(selfassessor_measures_history, nis_measures_history, nis_settings["alpha"])
