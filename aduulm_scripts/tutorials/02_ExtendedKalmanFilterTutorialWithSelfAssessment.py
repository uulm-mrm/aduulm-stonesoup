...
measurement_model = CartesianToBearingRange(
    ndim_state=4,
    mapping=(0, 2),
    noise_covar=np.diag([np.radians(0.002), 0.1]),  # Covariance matrix. 0.002 degree variance in
    # bearing and 0.1 metre in range
...
# %%
# Construct a Self-Assessor for the Extended Kalman Filter
# ^^^^^^^^^^^^^^^^^^^^^^^^^
#
# We're now ready to construct a self-assessor to monitor the assumptions of the extended Kalman filter.
